...
Route::group(['middleware' => ['XSS', 'subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::post('updateToDoData', 'HomeController@updateToDoData')->name('updateToDoData');
        Route::get('todo-subject-search', 'HomeController@searchTodoSubjects')->name('todoSubjectSearch');
        ...
        Route::post('restore-to-do', 'HomeController@restoreToDo')->name('restoreToDo');
        Route::post('update-to-do-board', 'HomeController@updateToDoBoard')->name('updateToDoBoard');
        Route::delete('delete-to-do', 'HomeController@deleteToDo')->name('deleteToDo');
        ...
        Route::redirect('subject-wise-attendance', '/subject-attendance', 302)->name('subject-wise-attendance')->middleware('userRolePermission:subject-attendance');
        ...
        Route::post('subject-attendance-report-search', 'Admin\StudentInfo\SmSubjectAttendanceController@subjectAttendanceReportSearch')->name('subject-attendance-report-search')->middleware('userRolePermission:subject-attendance-report');
        Route::get('subject-attendance-report-search', 'Admin\StudentInfo\SmSubjectAttendanceController@subjectAttendanceReport')->middleware('userRolePermission:subject-attendance-report');

        Route::get('subject-attendance-average-report', 'Admin\StudentInfo\SmSubjectAttendanceController@subjectAttendanceAverageReport')->middleware('userRolePermission:subject-attendance-report');
        Route::post('subject-attendance-average-report', 'Admin\StudentInfo\SmSubjectAttendanceController@subjectAttendanceAverageReportSearch')->middleware('userRolePermission:subject-attendance-report');
        ...
        Route::post('student-attendance-report-search', ['as' => 'student_attendance_report_search', 'uses' => 'Admin\StudentInfo\SmStudentAttendanceReportController@search'])->middleware('userRolePermission:student_attendance_report');
        Route::get('student-attendance-report-search', 'Admin\StudentInfo\SmStudentAttendanceReportController@index')->middleware('userRolePermission:student_attendance_report');
        Route::get('student-attendance/print/{class_id}/{section_id}/{month}/{year}/{shift?}/{branch_id?}', 'Admin\StudentInfo\SmStudentAttendanceReportController@print')->name('student-attendance-print')->middleware('userRolePermission:student_attendance_report');

        // for university module
        Route::get('un-student-attendance/print/{semester_id}/{month}/{year}/{branch_id?}', 'Admin\StudentInfo\SmStudentAttendanceReportController@unPrint')->name('un-student-attendance-print')->middleware('userRolePermission:student_attendance_report');
        ...
        // Phase AC — Optional Subject Attendance (merged into Special Class Attendance)
        Route::redirect('optional-subject-attendance', '/subject-attendance', 301)->name('optional-subject-attendance');
        Route::get('ajax-select-optional-subject', 'Admin\Academics\TrackedSubjectAttendanceController@ajaxSelectTrackedSubject')->name('ajax-select-optional-subject');
        Route::get('optional-subject-attendance-search', 'Admin\Academics\TrackedSubjectAttendanceController@search')->name('optional-subject-attendance-search')->middleware('userRolePermission:subject-attendance');
        Route::post('optional-subject-attendance-store', 'Admin\Academics\TrackedSubjectAttendanceController@storeAttendance')->name('optional-subject-attendance-store')->middleware('userRolePermission:subject-attendance');
        Route::redirect('optional-subject-attendance-report', '/subject-attendance-report-tracked', 301)->name('optional-subject-attendance-report');
        Route::post('optional-subject-attendance-report-search', 'Admin\Academics\TrackedSubjectAttendanceController@subjectAttendanceReportSearch')->name('optional-subject-attendance-report-search')->middleware('userRolePermission:subject-attendance');
        Route::get('optional-subject-enrollment-report', 'Admin\Academics\OptionalSubjectAttendanceController@enrollmentReport')->name('optional-subject-enrollment-report')->middleware('userRolePermission:optional-subject-enrollment-report');
        Route::post('optional-subject-enrollment-report-search', 'Admin\Academics\OptionalSubjectAttendanceController@enrollmentReportSearch')->name('optional-subject-enrollment-report-search')->middleware('userRolePermission:optional-subject-enrollment-report-search');

        Route::get('section', ['as' => 'section', 'uses' => 'Admin\Academics\SmSectionController@index'])->middleware('userRolePermission:section');

        Route::post('section-store', ['as' => 'section_store', 'uses' => 'Admin\Academics\SmSectionController@store']);
        Route::get('section-edit/{id}', ['as' => 'section_edit', 'uses' => 'Admin\Academics\SmSectionController@edit']);
        Route::post('section-update', ['as' => 'section_update', 'uses' => 'Admin\Academics\SmSectionController@update']);
        Route::get('section-delete/{id}', ['as' => 'section_delete', 'uses' => 'Admin\Academics\SmSectionController@delete']);
        ...
        Route::post('subject-bulk-attendance-mode', ['as' => 'subject_bulk_attendance_mode', 'uses' => 'Admin\Academics\SmSubjectController@bulkAttendanceMode'])->middleware('userRolePermission:subject_edit');

        // Phase AG — Configurable Subject Attendance
        Route::get('subject-attendance', 'Admin\Academics\TrackedSubjectAttendanceController@index')->name('subject-attendance')->middleware('userRolePermission:subject-attendance');
        Route::get('ajax-select-tracked-subject', 'Admin\Academics\TrackedSubjectAttendanceController@ajaxSelectTrackedSubject')->name('ajax-select-tracked-subject');
        Route::get('subject-attendance-search-tracked', 'Admin\Academics\TrackedSubjectAttendanceController@search')->name('subject-attendance-search-tracked')->middleware('userRolePermission:subject-attendance');
        Route::post('subject-attendance-store-tracked', 'Admin\Academics\TrackedSubjectAttendanceController@storeAttendance')->name('subject-attendance-store-tracked')->middleware('userRolePermission:subject-attendance');
        Route::get('subject-attendance-report-tracked', 'Admin\Academics\TrackedSubjectAttendanceController@subjectAttendanceReport')->name('subject-attendance-report-tracked')->middleware('userRolePermission:subject-attendance');
        Route::post('subject-attendance-report-tracked-search', 'Admin\Academics\TrackedSubjectAttendanceController@subjectAttendanceReportSearch')->name('subject-attendance-report-tracked-search')->middleware('userRolePermission:subject-attendance');
        ...
        Route::get('directFees/viewPaymentReceipt/{payment}', 'Admin\FeesCollection\SmFeesController@viewPaymentReceipt')->name('directFees.viewPaymentReceipt');
        ...
        // fees print
        Route::get('fees-payment-print/{payment}/{group}', ['as' => 'fees_payment_print', 'uses' => 'Admin\FeesCollection\SmFeesController@feesPaymentPrint']);
        ...
        Route::post('fees-statement-search', ['as' => 'fees_statement_search', 'uses' => 'Admin\FeesCollection\SmFeesController@feesStatementSearch'])->middleware('userRolePermission:fees_statement');
        ...
        Route::post('balance-fees-search', ['as' => 'balance_fees_searches', 'uses' => 'Admin\FeesCollection\SmFeesReportController@balanceFeesSearch'])->middleware('userRolePermission:balance_fees_report');
        Route::get('balance-fees-search', ['as' => 'balance_fees_search', 'uses' => 'Admin\FeesCollection\SmFeesReportController@balanceFeesReport'])->middleware('userRolePermission:balance_fees_report');
        ...
        Route::post('transaction-report-search', ['as' => 'transaction_report_searches', 'uses' => 'Admin\FeesCollection\SmCollectionReportController@transactionReportSearch'])->middleware('userRolePermission:transaction_report');
        Route::get('transaction-report-search', ['as' => 'transaction_report_search', 'uses' => 'Admin\FeesCollection\SmCollectionReportController@transactionReport'])->middleware('userRolePermission:transaction_report');
        ...
        Route::post('fine-report-search', ['as' => 'fine-report-search', 'uses' => 'Admin\FeesCollection\SmFeesController@fineReportSearch'])->middleware('userRolePermission:fine-report');

        // Class Report
        Route::get('class-report', ['as' => 'class_report', 'uses' => 'SmAcademicsController@classReport'])->middleware('userRolePermission:class_report');
        Route::post('class-report', ['as' => 'class_reports', 'uses' => 'SmAcademicsController@classReportSearch'])->middleware('userRolePermission:class_report');
        ...
        Route::post('merit-list-report', ['as' => 'merit_list_reports', 'uses' => 'Admin\Examination\SmExaminationController@meritListReportSearch'])->middleware('userRolePermission:merit_list_report');
        Route::get('merit-list/print/{exam_id}/{class_id}/{section_id}/{shift_id?}', 'Admin\Examination\SmExaminationController@meritListPrint')->name('merit-list/print')->middleware('userRolePermission:merit_list_report');

        // tabulation sheet report (legacy — same permission as modern tabulation)
        Route::get('reports-tabulation-sheet', ['as' => 'reports_tabulation_sheet', 'uses' => 'Admin\Examination\SmExaminationController@reportsTabulationSheet'])->middleware('userRolePermission:tabulation_sheet_report');
        Route::post('reports-tabulation-sheet', ['as' => 'reports_tabulation_sheets', 'uses' => 'Admin\Examination\SmExaminationController@reportsTabulationSheetSearch'])->middleware('userRolePermission:tabulation_sheet_report');
        ...
        Route::post('previous-record', 'SmStudentAdmissionController@previousRecordSearch')->name('previous-records')->middleware('userRolePermission:previous-record');
        ...
        Route::post('previous-class-results-view', 'Admin\Examination\SmExaminationController@previousClassResultsView')->name('previous-class-results-view')->middleware('userRolePermission:previous-class-results');
        Route::post('previous-student-record', 'Admin\Examination\SmExaminationController@previousStudentRecord')->name('previous-student-record')->middleware('userRolePermission:previous-class-results');

        Route::post('session-student', 'Admin\Examination\SmExaminationController@sessionStudentGet')->name('session_student')->middleware('userRolePermission:previous-class-results');

        Route::post('previous-class-results', 'Admin\Examination\SmExaminationController@previousClassResultsViewPrint')->name('previous-class-result-print')->middleware('userRolePermission:previous-class-results');
        // merit list Report
        ...
        Route::post('online-exam-report', ['as' => 'online_exam_reports', 'uses' => 'Admin\OnlineExam\SmOnlineExamController@onlineExamReportSearch'])->middleware('userRolePermission:online_exam_report');
        ...
        Route::post('class-routine-report', 'Admin\Academics\SmClassRoutineNewController@classRoutineReportSearch')->name('class_routine_reports')->middleware('userRolePermission:class_routine_report');
        ...
        Route::post('exam-routine-report', ['as' => 'exam_routine_reports', 'uses' => 'Admin\Examination\SmExamRoutineController@examRoutineReportSearch'])->middleware('userRolePermission:exam_routine_report');

        Route::get('exam-routine/print/{exam_id}', 'Admin\Examination\SmExamRoutineController@examRoutineReportSearchPrint')->name('exam-routine/print')->middleware('userRolePermission:exam_routine_report');
        ...
        Route::post('teacher-class-routine-report', 'Admin\Academics\SmClassRoutineNewController@teacherClassRoutineReportSearch')->name('teacher-class-routine-report')->middleware('userRolePermission:teacher_class_routine_report');
        // mark sheet Report
        Route::get('mark-sheet-report', ['as' => 'mark_sheet_report', 'uses' => 'Admin\Examination\SmExaminationController@markSheetReport'])->middleware('userRolePermission:mark_sheet_report');
        Route::post('mark-sheet-report', ['as' => 'mark_sheet_reports', 'uses' => 'Admin\Examination\SmExaminationController@markSheetReportSearch'])->middleware('userRolePermission:mark_sheet_report');

        Route::get('mark-sheet-report/print/{exam_id}/{class_id}/{section_id}/{student_id}', ['as' => 'mark_sheet_report_print', 'uses' => 'Admin\Examination\SmExaminationController@markSheetReportStudentPrint'])->middleware('userRolePermission:mark_sheet_report');
        ...
        Route::post('mark-sheet-report-student', ['as' => 'mark_sheet_report_students', 'uses' => 'Admin\Examination\SmExaminationController@markSheetReportStudentSearch'])->middleware('userRolePermission:mark_sheet_report_student');

        // 100 Percent mark sheet report student
        Route::get('percent-marksheet-report', ['as' => 'percent-marksheet-report', 'uses' => 'Admin\Examination\SmExaminationController@percentMarkSheetReport'])->middleware('userRolePermission:percent-marksheet-report');
        ...
        Route::post('student-fine-report', ['as' => 'student_fine_reports', 'uses' => 'Admin\FeesCollection\SmFeesController@studentFineReportSearch'])->middleware('userRolePermission:student_fine_report');
        ...
        // Phase AB: Enterprise Audit Logs (extends user-log)
        Route::get('audit-log-feed', ['as' => 'audit_log.feed', 'uses' => 'Admin\SystemSettings\AuditLogController@feed'])->middleware('userRolePermission:user_log');
        Route::get('audit-log-ajax', ['as' => 'audit_log.ajax', 'uses' => 'Admin\SystemSettings\AuditLogController@ajax'])->middleware('userRolePermission:user_log');
        Route::get('audit-log-export-pdf', ['as' => 'audit_log.export_pdf', 'uses' => 'Admin\SystemSettings\AuditLogController@exportPdf'])->middleware('userRolePermission:user_log');
        Route::post('audit-log-save-filter', ['as' => 'audit_log.save_filter', 'uses' => 'Admin\SystemSettings\AuditLogController@saveFilter'])->middleware('userRolePermission:user_log');
        Route::get('audit-log-widgets', ['as' => 'audit_log.widgets', 'uses' => 'Admin\SystemSettings\AuditLogController@widgets'])->middleware('userRolePermission:user_log');
        ...
        // Daily Ledger
        Route::get('accounts/daily-ledger', ['as' => 'accounts.daily-ledger', 'uses' => 'Admin\Accounts\SmAccountsController@dailyLedger'])->middleware('userRolePermission:accounts.daily-ledger');
        Route::post('accounts/daily-ledger', ['as' => 'accounts.daily-ledger.post', 'uses' => 'Admin\Accounts\SmAccountsController@dailyLedger'])->middleware('userRolePermission:accounts.daily-ledger');
        Route::get('accounts/daily-ledger/export', ['as' => 'accounts.daily-ledger.export', 'uses' => 'Admin\Accounts\SmAccountsController@dailyLedger'])->middleware('userRolePermission:accounts.daily-ledger');

        // Fixed Asset Register
        Route::resource('fixed-assets', 'Admin\Accounts\FixedAssetController');
        Route::get('fixed-assets-export', ['as' => 'fixed-assets.export', 'uses' => 'Admin\Accounts\FixedAssetController@exportExcel']);

        // Search account
        Route::get('search-account', ['as' => 'search_account', 'uses' => 'Admin\Accounts\SmAccountsController@searchAccount'])->middleware('userRolePermission:search_account');
        Route::post('search-account', ['as' => 'search_accounts', 'uses' => 'Admin\Accounts\SmAccountsController@searchAccountReportByDate'])->middleware('userRolePermission:search_account');
        ...
        Route::post('transaction-search', ['as' => 'transaction-search', 'uses' => 'Admin\Accounts\SmAccountsController@transactionSearch'])->middleware('userRolePermission:transaction');
        ...
        Route::post('accounts-payroll-report-search', ['as' => 'accounts-payroll-report-search', 'uses' => 'Admin\Accounts\SmAccountsController@accountsPayrollReportSearch'])->middleware('userRolePermission:accounts-payroll-report');
        ...
        Route::post('search-profit-by-date', ['as' => 'search_profit_by_dates', 'uses' => 'Admin\Accounts\SmAccountsController@searchProfitByDate'])->middleware('userRolePermission:profit');
        ...
        Route::post('student-dormitory-report', ['as' => 'student_dormitory_report_store', 'uses' => 'Admin\Dormitory\SmDormitoryController@studentDormitoryReportSearch'])->middleware('userRolePermission:student_dormitory_report_index');
        ...
        Route::post('student-transport-report-filter', ['as' => 'student_transport_report_store', 'uses' => 'Admin\Transport\SmTransportController@studentTransportReportSearch'])->middleware('userRolePermission:student_transport_report_index');
        ...
        // Seat Plan
        Route::get('seat-plan', ['as' => 'seat_plan', 'uses' => 'Admin\Examination\SmExaminationController@seatPlan'])->middleware('userRolePermission:exam');
        Route::post('seat-plan-report-search', ['as' => 'seat_plan_report_search_new', 'uses' => 'Admin\Examination\SmExaminationController@seatPlanReportSearch'])->middleware('userRolePermission:exam');
        Route::get('seat-plan-report-search', ['as' => 'seat_plan_report_search', 'uses' => 'Admin\Examination\SmExaminationController@seatPlan'])->middleware('userRolePermission:exam');
        ...
        // Unit Management (Phase 6)
        Route::middleware('unitContext')->group(function () {
            Route::get('units', 'Admin\Unit\UnitController@index')->name('units.index')->middleware('userRolePermission:units');
            Route::get('units/create', 'Admin\Unit\UnitController@create')->name('units.create')->middleware('userRolePermission:units.create');
            Route::post('units', 'Admin\Unit\UnitController@store')->name('units.store')->middleware('userRolePermission:units.create');
            Route::get('units/{unit}/edit', 'Admin\Unit\UnitController@edit')->name('units.edit')->middleware('userRolePermission:units.edit');
            Route::put('units/{unit}', 'Admin\Unit\UnitController@update')->name('units.update')->middleware('userRolePermission:units.edit');
            Route::delete('units/{unit}', 'Admin\Unit\UnitController@destroy')->name('units.destroy')->middleware('userRolePermission:units.destroy');
            Route::post('units/switch-context', 'Admin\Unit\UnitController@switchContext')->name('units.switch');
            Route::get('users/{user}/units', 'Admin\Unit\UnitAssignmentController@edit')->name('units.assign')->middleware('userRolePermission:units.assign');
            Route::put('users/{user}/units', 'Admin\Unit\UnitAssignmentController@update')->name('units.assign.update')->middleware('userRolePermission:units.assign');
            Route::get('ajax/hostels-for-unit/{unit}', 'Admin\Unit\UnitEcosystemController@hostelsForUnit')->name('units.ajax.hostels');
            Route::get('ajax/hostel-floors/{unit}', 'Admin\Unit\UnitEcosystemController@floorsForHostel')->name('units.ajax.floors');
            Route::get('ajax/hostel-rooms/{floor}', 'Admin\Unit\UnitEcosystemController@roomsForFloor')->name('units.ajax.hostel_rooms');
            Route::get('ajax/dormitories-for-hostel/{unit}', 'Admin\Unit\UnitEcosystemController@dormitoriesForHostel')->name('units.ajax.dorms');
            Route::get('ajax/rooms-for-dormitory/{dormitory}', 'Admin\Unit\UnitEcosystemController@roomsForDormitory')->name('units.ajax.rooms');

            Route::get('units/{unit}/fee-presets', 'Admin\Unit\UnitFeePresetController@edit')->name('units.fee-presets')->middleware('userRolePermission:units.edit');
            Route::post('units/{unit}/fee-presets', 'Admin\Unit\UnitFeePresetController@update')->name('units.fee-presets.update')->middleware('userRolePermission:units.edit');
            Route::post('unit-types', 'Admin\Unit\UnitTypeController@store')->name('unit-types.store')->middleware('userRolePermission:units');
        });

        Route::get('username-change-requests', 'Admin\Institutional\UsernameChangeRequestController@index')->name('username-change-requests');
        Route::post('username-change-requests/{id}/approve', 'Admin\Institutional\UsernameChangeRequestController@approve')->name('username-change-request.approve');
        Route::post('username-change-requests/{id}/reject', 'Admin\Institutional\UsernameChangeRequestController@reject')->name('username-change-request.reject');
        ...
        Route::get('accounts/inventory-receipts', 'Admin\Accounts\SmInventoryReceiptsController@index')->name('accounts-inventory-receipts')->middleware('userRolePermission:accounts-inventory-receipts');
        ...
        // student list
        Route::get('student-view/{student}/{type?}', ['as' => 'student_view', 'uses' => 'Admin\StudentInfo\SmStudentAdmissionController@view']);

        // student delete
        Route::post('student-delete', 'SmStudentAdmissionController@studentDelete')->name('student-delete');

        // student edit
        Route::get('student-edit/{student}', ['as' => 'student_edit', 'uses' => 'Admin\StudentInfo\SmStudentAdmissionController@edit'])->middleware('userRolePermission:student_edit');
        // Student Update
        ...
        // Student Export (comprehensive profile export / re-import)
        Route::get('all-student-export', [App\Http\Controllers\Admin\StudentInfo\StudentProfileExportController::class, 'index'])->name('all-student-export')->middleware('userRolePermission:all-student-export');
        Route::post('student-profile-export/download', [App\Http\Controllers\Admin\StudentInfo\StudentProfileExportController::class, 'download'])->name('student-profile-export.download')->middleware('userRolePermission:all-student-export-excel');
        Route::post('student-profile-export/settings', [App\Http\Controllers\Admin\StudentInfo\StudentProfileExportController::class, 'updateSettings'])->name('student-profile-export.settings')->middleware('userRolePermission:student_settings');
        Route::post('student-profile-import/preview', [App\Http\Controllers\Admin\StudentInfo\StudentProfileExportController::class, 'importPreview'])->name('student-profile-import.preview')->middleware('userRolePermission:import_student');
        Route::post('student-profile-import/apply', [App\Http\Controllers\Admin\StudentInfo\StudentProfileExportController::class, 'importApply'])->name('student-profile-import.apply')->middleware('userRolePermission:import_student');
        ...
        Route::get('student-absence-follow-ups', ['as' => 'student-absence-follow-ups', 'uses' => 'Admin\StudentInfo\StudentAbsenceFollowUpController@index'])
            ->middleware('userRolePermission:student-absence-follow-ups');
        Route::post('student-absence-follow-ups/reason', ['as' => 'student-absence-follow-ups.reason', 'uses' => 'Admin\StudentInfo\StudentAbsenceFollowUpController@submitReason'])
            ->middleware('userRolePermission:student-absence-follow-ups.reason');
        ...
        Route::post('student-report', ['as' => 'student_report_search', 'uses' => 'Admin\StudentInfo\SmStudentReportController@studentReportSearch'])->middleware('userRolePermission:student_report');
        ...
        Route::post('guardian-report-search', ['as' => 'guardian_report_search_new', 'uses' => 'Admin\StudentInfo\SmStudentReportController@guardianReportSearch'])->middleware('userRolePermission:guardian_report');
        Route::get('guardian-report-search', ['as' => 'guardian_report_search', 'uses' => 'Admin\StudentInfo\SmStudentReportController@guardianReport'])->middleware('userRolePermission:guardian_report');
        ...
        Route::post('student-history-search', ['as' => 'student_history_search_new', 'uses' => 'Admin\StudentInfo\SmStudentReportController@studentHistorySearch'])->middleware('userRolePermission:student_history');
        Route::get('student-history-search', ['as' => 'student_history_search', 'uses' => 'Admin\StudentInfo\SmStudentReportController@studentHistory'])->middleware('userRolePermission:student_history');
        ...
        Route::post('student-login-search', ['as' => 'student_login_report_search', 'uses' => 'Admin\StudentInfo\SmStudentReportController@studentLoginSearch'])->middleware('userRolePermission:student_login_report');
        Route::get('student-login-search', ['as' => 'student_login_search', 'uses' => 'Admin\StudentInfo\SmStudentReportController@studentLoginReport'])->middleware('userRolePermission:student_login_report');
        ...
        Route::redirect('student-report-search', '/student-report', 302)->middleware('userRolePermission:student_report');
        ...
        Route::post('tabulation-sheet-report', ['as' => 'tabulation_sheet_report_search', 'uses' => 'Admin\Report\SmReportController@tabulationSheetReportSearch'])->middleware('userRolePermission:tabulation_sheet_report');
        Route::post('tabulation-sheet/print', 'Admin\Report\SmReportController@tabulationSheetReportPrint')->name('tabulation-sheet.print')->middleware('userRolePermission:tabulation_sheet_report');
        ...
        Route::post('progress-card-report', ['as' => 'progress_card_report_search', 'uses' => 'Admin\Report\SmReportController@progressCardReportSearch'])->middleware('userRolePermission:progress_card_report');

        Route::get('custom-progress-card-report-percent', ['as' => 'custom_progress_card_report_percent', 'uses' => 'Admin\Report\SmReportController@customProgressCardReport'])->middleware('userRolePermission:custom_progress_card_report_percent');

        Route::post('progress-card/print', 'Admin\Report\SmReportController@progressCardPrint')->name('progress-card/print')->middleware('userRolePermission:progress_card_report');
        ...
        Route::get('edit-staff/{staff}', ['as' => 'editStaff', 'uses' => 'Admin\Hr\SmStaffController@editStaff']);
        ...
        Route::get('view-staff/{staff}', ['as' => 'viewStaff', 'uses' => 'Admin\Hr\SmStaffController@viewStaff']);
        ...
        Route::post('staff-attendance-report', ['as' => 'staff_attendance_report_search', 'uses' => 'Admin\Hr\SmStaffAttendanceController@staffAttendanceReportSearch'])->middleware('userRolePermission:staff_attendance_report');

        Route::get('staff-attendance/print/{role_id}/{month}/{year}/{branch_id?}', 'Admin\Hr\SmStaffAttendanceController@staffAttendancePrint')->name('staff-attendance/print')->middleware('userRolePermission:staff_attendance_report');
        ...
        // payroll
        // Salary Sheet Workflow (Dept Head → Accounts → Payroll Generation)
        Route::get('salary-sheets', ['as' => 'salary-sheet.index', 'uses' => 'Admin\Hr\SalarySheetController@index'])->middleware('userRolePermission:salary-sheet.index');
        Route::get('salary-sheets/create', ['as' => 'salary-sheet.create', 'uses' => 'Admin\Hr\SalarySheetController@create'])->middleware('userRolePermission:salary-sheet.create');
        Route::post('salary-sheets', ['as' => 'salary-sheet.store', 'uses' => 'Admin\Hr\SalarySheetController@store'])->middleware('userRolePermission:salary-sheet.create');
        Route::get('salary-sheets/{salarySheet}', ['as' => 'salary-sheet.show', 'uses' => 'Admin\Hr\SalarySheetController@show'])->middleware('userRolePermission:salary-sheet.index');
        Route::post('salary-sheets/{salarySheet}/submit', ['as' => 'salary-sheet.submit', 'uses' => 'Admin\Hr\SalarySheetController@submit'])->middleware('userRolePermission:salary-sheet.submit');
        Route::post('salary-sheets/{salarySheet}/review', ['as' => 'salary-sheet.review', 'uses' => 'Admin\Hr\SalarySheetController@review'])->middleware('userRolePermission:salary-sheet.review');
        Route::post('salary-sheets/{salarySheet}/approve', ['as' => 'salary-sheet.approve', 'uses' => 'Admin\Hr\SalarySheetController@approve'])->middleware('userRolePermission:salary-sheet.approve');
        Route::post('salary-sheets/{salarySheet}/reject', ['as' => 'salary-sheet.reject', 'uses' => 'Admin\Hr\SalarySheetController@reject'])->middleware('userRolePermission:salary-sheet.reject');
        Route::post('salary-sheets/{salarySheet}/generate-payroll', ['as' => 'salary-sheet.generate-payroll', 'uses' => 'Admin\Hr\SalarySheetController@generatePayroll'])->middleware('userRolePermission:salary-sheet.generate-payroll');
        Route::get('salary-sheets/{salarySheet}/export-csv', ['as' => 'salary-sheet.export-csv', 'uses' => 'Admin\Hr\SalarySheetController@exportCsv'])->middleware('userRolePermission:salary-sheet.index');
        Route::get('salary-sheets/{salarySheet}/export-pdf', ['as' => 'salary-sheet.export-pdf', 'uses' => 'Admin\Hr\SalarySheetController@exportPdf'])->middleware('userRolePermission:salary-sheet.index');
        Route::get('salary-sheet-staff-for-dept', ['as' => 'salary-sheet.staff-for-dept', 'uses' => 'Admin\Hr\SalarySheetController@getStaffForDept']);
        ...
        Route::post('payroll-report', 'Admin\Hr\SmPayrollController@searchPayrollReport')->name('searchPayrollReport')->middleware('userRolePermission:payroll-report');
        ...
        Route::post('evaluation-report', ['as' => 'search-evaluation', 'uses' => 'Admin\Homework\SmHomeworkController@searchEvaluation'])->middleware('userRolePermission:evaluation-report');
        ...
        Route::controller(\App\Http\Controllers\Admin\SystemSettings\AethonNotificationAdminController::class)->group(function () {
            Route::get('aethon-notification-templates', 'index')->name('aethon.notification.templates')->middleware('userRolePermission:notification_settings');
            Route::post('aethon-notification-templates/sync', 'syncTemplates')->name('aethon.notification.templates.sync')->middleware('userRolePermission:notification_settings');
            Route::post('aethon-notification-templates/update', 'updateEventTemplateForm')->name('aethon.notification.templates.update')->middleware('userRolePermission:notification_settings');
        });

        Route::controller(\App\Http\Controllers\Admin\SystemSettings\AethonNotificationRulesController::class)->group(function () {
            Route::get('aethon-notification-rules', 'index')->name('aethon.notification.rules')->middleware('userRolePermission:notification_settings');
            Route::post('aethon-notification-rules', 'store')->name('aethon.notification.rules.store')->middleware('userRolePermission:notification_settings');
            Route::post('aethon-notification-rules/{id}/toggle', 'toggle')->name('aethon.notification.rules.toggle')->middleware('userRolePermission:notification_settings');
            Route::delete('aethon-notification-rules/{id}', 'destroy')->name('aethon.notification.rules.destroy')->middleware('userRolePermission:notification_settings');
        });

        Route::controller(\App\Http\Controllers\Admin\SystemSettings\AethonNotificationPreferencesController::class)->group(function () {
            Route::get('aethon-notification-preferences', 'index')->name('aethon.notification.preferences')->middleware('userRolePermission:notification_settings');
            Route::post('aethon-notification-preferences', 'update')->name('aethon.notification.preferences.update')->middleware('userRolePermission:notification_settings');
        });
        ...
        Route::get('view-item-receive/{id}', 'Admin\Inventory\SmItemReceiveController@viewItemReceive')->name('view-item-receive')->middleware('userRolePermission:view-item-receive');
        ...
        Route::post('save-item-sell-data', 'Admin\Inventory\SmItemSellController@saveItemSellData')->name('save-item-sell-data')->middleware('userRolePermission:save-item-sell-data');
        ...
        Route::post('update-item-sell-data', 'Admin\Inventory\SmItemSellController@UpdateItemSellData')->name('update-item-sell-data')->middleware('userRolePermission:edit-item-sell');
        ...
        // Inventory approval workflows (Phase 1)
        Route::get('inv-approval-inbox', 'Admin\Inventory\InvApprovalInboxController@index')->name('inv-approval-inbox')->middleware('userRolePermission:inv-approval-inbox');
        Route::get('inv-approval-inbox/{id}', 'Admin\Inventory\InvApprovalInboxController@show')->name('inv-approval-inbox-show')->middleware('userRolePermission:inv-approval-inbox');
        Route::post('inv-approval-inbox/{id}/act', 'Admin\Inventory\InvApprovalInboxController@act')->name('inv-approval-act')->middleware('userRolePermission:inv-approval-act');
        Route::post('inv-approval-inbox/{id}/line/{lineId}', 'Admin\Inventory\InvApprovalInboxController@actLine')->name('inv-approval-line-act')->middleware('userRolePermission:inv-approval-act');
        Route::post('inv-approval-inbox/{id}/update', 'Admin\Inventory\InvApprovalInboxController@updateDocument')->name('inv-approval-update-document')->middleware('userRolePermission:inv-approval-act');

        Route::get('inv-purchase', 'Admin\Inventory\InvPurchaseRequisitionController@index')->name('inv-purchase')->middleware('userRolePermission:inv-purchase');
        Route::get('inv-purchase-approvals', 'Admin\Inventory\InvPurchaseRequisitionController@approvals')->name('inv-purchase-approvals')->middleware('userRolePermission:inv-purchase');
        Route::get('inv-purchase/create', 'Admin\Inventory\InvPurchaseRequisitionController@create')->name('inv-purchase-create')->middleware('userRolePermission:inv-purchase-create');
        Route::post('inv-purchase', 'Admin\Inventory\InvPurchaseRequisitionController@store')->name('inv-purchase-store')->middleware('userRolePermission:inv-purchase-store');
        Route::post('inv-purchase/quick-store', 'Admin\Inventory\InvPurchaseRequisitionController@quickStore')->name('inv-purchase-quick-store')->middleware('userRolePermission:item-store-store');
        Route::get('inv-purchase/item-lookup', 'Admin\Inventory\InvPurchaseRequisitionController@itemLookup')->name('inv-purchase-item-lookup')->middleware('userRolePermission:inv-purchase-create');
        Route::get('inv-purchase/{id}/edit', 'Admin\Inventory\InvPurchaseRequisitionController@edit')->name('inv-purchase-edit')->middleware('userRolePermission:inv-purchase-create');
        Route::put('inv-purchase/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@update')->name('inv-purchase-update')->middleware('userRolePermission:inv-purchase-store');
        Route::delete('inv-purchase/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@destroy')->name('inv-purchase-delete')->middleware('userRolePermission:inv-purchase-store');
        Route::get('inv-purchase/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@show')->name('inv-purchase-show')->middleware('userRolePermission:inv-purchase-show');
        Route::post('inv-purchase/{id}/submit', 'Admin\Inventory\InvPurchaseRequisitionController@submit')->name('inv-purchase-submit')->middleware('userRolePermission:inv-purchase-submit');
        Route::post('inv-purchase/{id}/verify', 'Admin\Inventory\InvPurchaseRequisitionController@verify')->name('inv-purchase-verify')->middleware('userRolePermission:inv-purchase-verify');
        Route::post('inv-purchase/{id}/committee-pre-approve', 'Admin\Inventory\InvPurchaseRequisitionController@committeePreApprove')->name('inv-purchase-committee-pre-approve')->middleware('userRolePermission:inv-purchase-committee-approve');
        Route::post('inv-purchase/{id}/quotations', 'Admin\Inventory\InvPurchaseRequisitionController@quotations')->name('inv-purchase-quotations')->middleware('userRolePermission:inv-purchase-quotations');
        Route::post('inv-purchase/{id}/evaluate', 'Admin\Inventory\InvPurchaseRequisitionController@evaluate')->name('inv-purchase-evaluate')->middleware('userRolePermission:inv-purchase-evaluate');
        Route::post('inv-purchase/{id}/committee-approve', 'Admin\Inventory\InvPurchaseRequisitionController@committeeApprove')->name('inv-purchase-committee-approve')->middleware('userRolePermission:inv-purchase-committee-approve');
        Route::post('inv-purchase/{id}/approval-step', 'Admin\Inventory\InvPurchaseRequisitionController@approvalStep')->name('inv-purchase-approval-step')->middleware('userRolePermission:inv-purchase-approval-step');
        Route::post('inv-purchase/{id}/po', 'Admin\Inventory\InvPurchaseRequisitionController@issuePO')->name('inv-purchase-po')->middleware('userRolePermission:inv-purchase-po');
        Route::post('inv-purchase/{id}/receive-goods', 'Admin\Inventory\InvPurchaseRequisitionController@receiveGoods')->name('inv-purchase-receive-goods')->middleware('userRolePermission:inv-purchase-receive-goods');
        Route::post('inv-purchase/{id}/payment', 'Admin\Inventory\InvPurchaseRequisitionController@processPayment')->name('inv-purchase-payment')->middleware('userRolePermission:inv-purchase-payment');
        Route::post('inv-purchase/{id}/message', 'Admin\Inventory\InvPurchaseRequisitionController@postMessage')->name('inv-purchase-message')->middleware('userRolePermission:inv-purchase-show');
        Route::get('inv-purchase/{id}/messages', 'Admin\Inventory\InvPurchaseRequisitionController@fetchMessages')->name('inv-purchase-messages')->middleware('userRolePermission:inv-purchase-show');

        // Legacy /inv/purchase URLs (same as old portal)
        Route::prefix('inv')->group(function () {
            Route::get('purchase', 'Admin\Inventory\InvPurchaseRequisitionController@index')->name('inv-purchase-portal')->middleware('userRolePermission:inv-purchase');
            Route::get('purchase/create', 'Admin\Inventory\InvPurchaseRequisitionController@create')->name('inv-purchase-portal-create')->middleware('userRolePermission:inv-purchase-create');
            Route::post('purchase/store', 'Admin\Inventory\InvPurchaseRequisitionController@store')->name('inv-purchase-portal-store')->middleware('userRolePermission:inv-purchase-store');
            Route::post('purchase/quick-store', 'Admin\Inventory\InvPurchaseRequisitionController@quickStore')->name('inv-purchase-portal-quick-store')->middleware('userRolePermission:item-store-store');
            Route::get('purchase/item-lookup', 'Admin\Inventory\InvPurchaseRequisitionController@itemLookup')->name('inv-purchase-portal-item-lookup')->middleware('userRolePermission:inv-purchase-create');
            Route::get('purchase/edit/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@edit')->name('inv-purchase-portal-edit')->middleware('userRolePermission:inv-purchase-create');
            Route::put('purchase/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@update')->name('inv-purchase-portal-update')->middleware('userRolePermission:inv-purchase-store');
            Route::delete('purchase/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@destroy')->name('inv-purchase-portal-delete')->middleware('userRolePermission:inv-purchase-store');
            Route::get('purchase/view/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@show')->name('inv-purchase-portal-show')->middleware('userRolePermission:inv-purchase-show');
            Route::post('purchase/{id}/submit', 'Admin\Inventory\InvPurchaseRequisitionController@submit')->name('inv-purchase-portal-submit')->middleware('userRolePermission:inv-purchase-submit');
            Route::post('purchase/verify/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@verify')->name('inv-purchase-portal-verify')->middleware('userRolePermission:inv-purchase-verify');
            Route::post('purchase/quotations/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@quotations')->name('inv-purchase-portal-quotations')->middleware('userRolePermission:inv-purchase-quotations');
            Route::post('purchase/evaluate/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@evaluate')->name('inv-purchase-portal-evaluate')->middleware('userRolePermission:inv-purchase-evaluate');
            Route::post('purchase/approve/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@committeeApprove')->name('inv-purchase-portal-approve')->middleware('userRolePermission:inv-purchase-committee-approve');
            Route::post('purchase/approval-step/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@approvalStep')->name('inv-purchase-portal-approval-step')->middleware('userRolePermission:inv-purchase-approval-step');
            Route::post('purchase/po/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@issuePO')->name('inv-purchase-portal-po')->middleware('userRolePermission:inv-purchase-po');
            Route::post('purchase/receipt/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@receiveGoods')->name('inv-purchase-portal-receipt')->middleware('userRolePermission:inv-purchase-receive-goods');
            Route::post('purchase/payment/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@processPayment')->name('inv-purchase-portal-payment')->middleware('userRolePermission:inv-purchase-payment');
            Route::post('purchase/message/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@postMessage')->name('inv-purchase-portal-message')->middleware('userRolePermission:inv-purchase-show');
            Route::get('purchase/messages/{id}', 'Admin\Inventory\InvPurchaseRequisitionController@fetchMessages')->name('inv-purchase-portal-messages')->middleware('userRolePermission:inv-purchase-show');
        });

        Route::get('inv-stock-opening', 'Admin\Inventory\InvStockOpeningController@index')->name('inv-stock-opening')->middleware('userRolePermission:inv-stock-opening');
        Route::get('inv-stock-opening/create', 'Admin\Inventory\InvStockOpeningController@create')->name('inv-stock-opening-create')->middleware('userRolePermission:inv-stock-opening-create');
        Route::post('inv-stock-opening', 'Admin\Inventory\InvStockOpeningController@store')->name('inv-stock-opening-store')->middleware('userRolePermission:inv-stock-opening-store');
        Route::get('inv-stock-opening/{id}', 'Admin\Inventory\InvStockOpeningController@show')->name('inv-stock-opening-show')->middleware('userRolePermission:inv-stock-opening-show');
        Route::post('inv-stock-opening/{id}/submit', 'Admin\Inventory\InvStockOpeningController@submit')->name('inv-stock-opening-submit')->middleware('userRolePermission:inv-stock-opening-submit');

        Route::get('inv-stock-ledger', 'Admin\Inventory\InvStockLedgerController@index')->name('inv-stock-ledger')->middleware('userRolePermission:inv-stock-ledger');

        Route::get('inv-approval-settings', 'Admin\Inventory\InvApprovalSettingsController@index')->name('inv-approval-settings')->middleware('userRolePermission:inv-approval-settings');
        Route::post('inv-approval-settings', 'Admin\Inventory\InvApprovalSettingsController@update')->name('inv-approval-settings-update')->middleware('userRolePermission:inv-approval-settings-update');

        // Inventory approval workflows (Phase 2 — GRN, sell, issue)
        Route::get('inv-goods-receipt', 'Admin\Inventory\InvGoodsReceiptController@index')->name('inv-goods-receipt')->middleware('userRolePermission:inv-goods-receipt');
        Route::get('inv-goods-receipt/create', 'Admin\Inventory\InvGoodsReceiptController@create')->name('inv-goods-receipt-create')->middleware('userRolePermission:inv-goods-receipt-create');
        Route::post('inv-goods-receipt/quick-supplier', 'Admin\Inventory\InvGoodsReceiptController@quickSupplierStore')->name('inv-goods-receipt-quick-supplier')->middleware('userRolePermission:inv-goods-receipt-create');
        Route::get('inv-goods-receipt/item-lookup', 'Admin\Inventory\InvGoodsReceiptController@itemLookup')->name('inv-goods-receipt-item-lookup')->middleware('userRolePermission:inv-goods-receipt-create');
        Route::get('inv-goods-receipt/from-requisition/{requisitionId}', 'Admin\Inventory\InvGoodsReceiptController@fromRequisition')->name('inv-goods-receipt-from-pr')->middleware('userRolePermission:inv-goods-receipt-create');
        Route::post('inv-goods-receipt', 'Admin\Inventory\InvGoodsReceiptController@store')->name('inv-goods-receipt-store')->middleware('userRolePermission:inv-goods-receipt-store');
        Route::get('inv-goods-receipt/{id}', 'Admin\Inventory\InvGoodsReceiptController@show')->name('inv-goods-receipt-show')->middleware('userRolePermission:inv-goods-receipt-show');
        Route::post('inv-goods-receipt/{id}/submit', 'Admin\Inventory\InvGoodsReceiptController@submit')->name('inv-goods-receipt-submit')->middleware('userRolePermission:inv-goods-receipt-submit');

        Route::get('inv-item-sell-request/create', 'Admin\Inventory\InvItemSellRequestController@create')->name('inv-item-sell-request-create')->middleware('userRolePermission:inv-item-sell-request-create');
        Route::post('inv-item-sell-request', 'Admin\Inventory\InvItemSellRequestController@store')->name('inv-item-sell-request-store')->middleware('userRolePermission:inv-item-sell-request-store');
        Route::get('inv-item-sell-request/{id}', 'Admin\Inventory\InvItemSellRequestController@show')->name('inv-item-sell-request-show')->middleware('userRolePermission:inv-item-sell-request-show');

        Route::get('inv-item-issue-request/create', 'Admin\Inventory\InvStockTransferController@create')->name('inv-item-issue-request-create')->middleware('userRolePermission:inv-item-issue-request-create');
        Route::post('inv-item-issue-request', 'Admin\Inventory\InvStockTransferController@store')->name('inv-item-issue-request-store')->middleware('userRolePermission:inv-item-issue-request-store');
        Route::get('inv-item-issue-request/{id}', 'Admin\Inventory\InvStockTransferController@show')->name('inv-item-issue-request-show')->middleware('userRolePermission:inv-item-issue-request-show');

        Route::get('inv-maintenance', 'Admin\Inventory\InvMaintenanceController@index')->name('inv-maintenance')->middleware('userRolePermission:inv-maintenance');
        Route::get('inv-maintenance/inbox', 'Admin\Inventory\InvMaintenanceInboxController@index')->name('inv-maintenance-inbox')->middleware('userRolePermission:inv-maintenance-inbox');
        Route::get('inv-maintenance/create', 'Admin\Inventory\InvMaintenanceController@create')->name('inv-maintenance-create')->middleware('userRolePermission:inv-maintenance-create');
        Route::get('inv-maintenance/locations-by-unit', 'Admin\Inventory\InvMaintenanceController@locationsByUnit')->name('inv-maintenance-locations')->middleware('userRolePermission:inv-maintenance-create');
        Route::post('inv-maintenance/quick-location', 'Admin\Inventory\InvMaintenanceController@quickLocation')->name('inv-maintenance-quick-location')->middleware('userRolePermission:inv-maintenance-create');
        Route::post('inv-maintenance/quick-department', 'Admin\Inventory\InvMaintenanceController@quickDepartment')->name('inv-maintenance-quick-department')->middleware('userRolePermission:inv-maintenance-create');
        Route::post('inv-maintenance', 'Admin\Inventory\InvMaintenanceController@store')->name('inv-maintenance-store')->middleware('userRolePermission:inv-maintenance-store');
        Route::get('inv-maintenance/{id}', 'Admin\Inventory\InvMaintenanceController@show')->name('inv-maintenance-show')->middleware('userRolePermission:inv-maintenance-show');
        Route::post('inv-maintenance/{id}/submit', 'Admin\Inventory\InvMaintenanceController@submit')->name('inv-maintenance-submit')->middleware('userRolePermission:inv-maintenance-submit');
        Route::post('inv-maintenance/{id}/complete', 'Admin\Inventory\InvMaintenanceController@complete')->name('inv-maintenance-complete')->middleware('userRolePermission:inv-maintenance-complete');
        Route::post('inv-maintenance/{id}/completion-date', 'Admin\Inventory\InvMaintenanceController@setCompletionDate')->name('inv-maintenance-completion-date')->middleware('userRolePermission:inv-maintenance-complete');
        Route::post('inv-maintenance/{id}/verify', 'Admin\Inventory\InvMaintenanceController@verify')->name('inv-maintenance-verify')->middleware('userRolePermission:inv-maintenance-show');
        Route::post('inv-maintenance/{id}/receipt', 'Admin\Inventory\InvMaintenanceController@uploadReceipt')->name('inv-maintenance-receipt')->middleware('userRolePermission:inv-maintenance-show');

        // kitchen inventory
        Route::get('inv-kitchen', 'Admin\Inventory\InvKitchenController@index')->name('inv-kitchen')->middleware('userRolePermission:inv-kitchen');
        Route::get('inv-kitchen/utilizations', 'Admin\Inventory\InvKitchenReportController@utilizationList')->name('inv-kitchen-utilization-index')->middleware('userRolePermission:inv-kitchen-utilization-index');
        Route::get('inv-kitchen/utilization/create', 'Admin\Inventory\InvKitchenUtilizationController@create')->name('inv-kitchen-utilization-create')->middleware('userRolePermission:inv-kitchen-utilization-create');
        Route::post('inv-kitchen/utilization', 'Admin\Inventory\InvKitchenUtilizationController@store')->name('inv-kitchen-utilization-store')->middleware('userRolePermission:inv-kitchen-utilization-store');
        Route::get('inv-kitchen/utilization/{id}', 'Admin\Inventory\InvKitchenUtilizationController@show')->name('inv-kitchen-utilization-show')->middleware('userRolePermission:inv-kitchen-utilization-show');
        Route::get('inv-kitchen/recipe-lines', 'Admin\Inventory\InvKitchenUtilizationController@recipeLines')->name('inv-kitchen-recipe-lines')->middleware('userRolePermission:inv-kitchen-utilization-create');
        Route::get('inv-kitchen/recipes-by-unit', 'Admin\Inventory\InvKitchenUtilizationController@recipesForUnit')->name('inv-kitchen-recipes-by-unit')->middleware('userRolePermission:inv-kitchen-utilization-create');
        Route::post('inv-kitchen/procurement-from-alert', 'Admin\Inventory\InvKitchenUtilizationController@procurementFromAlert')->name('inv-kitchen-procurement-from-alert')->middleware('userRolePermission:inv-kitchen-procurement-from-alert');
        Route::get('inv-kitchen/recipes', 'Admin\Inventory\InvKitchenRecipeController@index')->name('inv-kitchen-recipes')->middleware('userRolePermission:inv-kitchen-recipes');
        Route::get('inv-kitchen/recipes/create', 'Admin\Inventory\InvKitchenRecipeController@create')->name('inv-kitchen-recipes-create')->middleware('userRolePermission:inv-kitchen-recipes-create');
        Route::post('inv-kitchen/recipes', 'Admin\Inventory\InvKitchenRecipeController@store')->name('inv-kitchen-recipes-store')->middleware('userRolePermission:inv-kitchen-recipes-store');
        Route::get('inv-kitchen/recipes/{id}/edit', 'Admin\Inventory\InvKitchenRecipeController@edit')->name('inv-kitchen-recipes-edit')->middleware('userRolePermission:inv-kitchen-recipes-edit');
        Route::match(['put', 'patch'], 'inv-kitchen/recipes/{id}', 'Admin\Inventory\InvKitchenRecipeController@update')->name('inv-kitchen-recipes-update')->middleware('userRolePermission:inv-kitchen-recipes-update');
        Route::get('inv-kitchen/report/daily', 'Admin\Inventory\InvKitchenReportController@daily')->name('inv-kitchen-report-daily')->middleware('userRolePermission:inv-kitchen-report-daily');
        Route::get('inv-kitchen/report/monthly', 'Admin\Inventory\InvKitchenReportController@monthly')->name('inv-kitchen-report-monthly')->middleware('userRolePermission:inv-kitchen-report-monthly');
        Route::get('inv-kitchen/report/low-stock', 'Admin\Inventory\InvKitchenReportController@lowStock')->name('inv-kitchen-report-low-stock')->middleware('userRolePermission:inv-kitchen-report-low-stock');
        Route::get('inv-kitchen/report/low-stock/export', 'Admin\Inventory\InvKitchenReportController@lowStock')->name('inv-kitchen-report-low-stock-export')->middleware('userRolePermission:inv-kitchen-report-low-stock');
        Route::get('inv-kitchen/report/daily/export', 'Admin\Inventory\InvKitchenReportController@daily')->name('inv-kitchen-report-daily-export')->middleware('userRolePermission:inv-kitchen-report-daily');

        // kitchen setup & operations
        Route::get('inv-kitchen/setup', 'Admin\Inventory\InvKitchenSetupController@index')->name('inv-kitchen-setup')->middleware('userRolePermission:inv-kitchen-setup');
        Route::post('inv-kitchen/setup', 'Admin\Inventory\InvKitchenSetupController@store')->name('inv-kitchen-setup-store')->middleware('userRolePermission:inv-kitchen-setup-store');
        Route::get('inv-kitchen/setup/export', 'Admin\Inventory\InvKitchenSetupController@exportItems')->name('inv-kitchen-setup-export')->middleware('userRolePermission:inv-kitchen-setup');
        Route::get('inv-kitchen/quick-issue', 'Admin\Inventory\InvKitchenOperationsController@quickIssueForm')->name('inv-kitchen-quick-issue')->middleware('userRolePermission:inv-kitchen-quick-issue');
        Route::post('inv-kitchen/quick-issue', 'Admin\Inventory\InvKitchenOperationsController@quickIssueStore')->name('inv-kitchen-quick-issue-store')->middleware('userRolePermission:inv-kitchen-quick-issue-store');
        Route::post('inv-kitchen/repeat-last', 'Admin\Inventory\InvKitchenOperationsController@repeatLast')->name('inv-kitchen-repeat-last')->middleware('userRolePermission:inv-kitchen-repeat-last');
        Route::get('inv-kitchen/waste', 'Admin\Inventory\InvKitchenOperationsController@wasteForm')->name('inv-kitchen-waste')->middleware('userRolePermission:inv-kitchen-waste');
        Route::post('inv-kitchen/waste', 'Admin\Inventory\InvKitchenOperationsController@wasteStore')->name('inv-kitchen-waste-store')->middleware('userRolePermission:inv-kitchen-waste-store');
        Route::get('inv-kitchen/fast-purchase', 'Admin\Inventory\InvKitchenOperationsController@fastPurchaseForm')->name('inv-kitchen-fast-purchase')->middleware('userRolePermission:inv-kitchen-fast-purchase');
        Route::post('inv-kitchen/fast-purchase', 'Admin\Inventory\InvKitchenOperationsController@fastPurchaseStore')->name('inv-kitchen-fast-purchase-store')->middleware('userRolePermission:inv-kitchen-fast-purchase-store');
        Route::get('inv-kitchen/item-stock', 'Admin\Inventory\InvKitchenOperationsController@itemStock')->name('inv-kitchen-item-stock')->middleware('userRolePermission:inv-kitchen-quick-issue');

        // library member
        Route::redirect('library-member', '/member-list')->name('library-member');
        Route::post('library-member', function () {
            return redirect()->route('member-list');
        })->name('library-member-store');
        Route::get('cancel-membership/{id}', function () {
            return redirect()->route('member-list');
        ...
        Route::get('download-database/{id}', 'Admin\SystemSettings\SmSystemSettingController@downloadDatabase')->middleware('userRolePermission:get-backup-db');
        ...
        Route::get('restore-database/{id}', 'Admin\SystemSettings\SmSystemSettingController@restoreDatabase')->name('restore-database')->middleware('userRolePermission:get-backup-db');
        ...
        Route::get('ui-feature-settings', 'Admin\SystemSettings\UiFeatureSettingsController@index')->name('ui-feature-settings')->middleware('userRolePermission:general-settings');
        Route::post('ui-feature-settings-update', 'Admin\SystemSettings\UiFeatureSettingsController@update')->name('ui-feature-settings-update')->middleware('userRolePermission:general-settings');
        Route::post('ui-feature-settings-reset', 'Admin\SystemSettings\UiFeatureSettingsController@reset')->name('ui-feature-settings-reset')->middleware('userRolePermission:general-settings');
        ...
        Route::get('custom-merit-list/print/{class}/{section}', 'Admin\Examination\CustomResultSettingController@meritListReportPrint')->name('custom-merit-list-print')->middleware('userRolePermission:custom-merit-list');
        Route::post('custom-merit-list', 'Admin\Examination\CustomResultSettingController@meritListReport')->name('custom-merit-list-search')->middleware('userRolePermission:custom-merit-list');
        ...
        Route::post('custom-progress-card/print', 'Admin\Examination\CustomResultSettingController@progressCardReportPrint')->name('custom-progress-card-print')->middleware('userRolePermission:custom-progress-card');
        ...
        Route::post('login-password-update', 'Admin\RolePermission\SmResetPasswordController@resetStudentPassword')->name('login-password-update')->middleware('userRolePermission:login-access-control');
    ...
    Route::get('student/{student}/assign-class', 'Admin\StudentInfo\SmStudentAdmissionController@assignClass')->name('student.assign-class');
    ...
    // Teacher Evaluation Settings
        require __DIR__ . '/teacher_call_logs.routes.php';
        require __DIR__ . '/hostel_activity.routes.php';
        require __DIR__ . '/biometric.routes.php';
        require __DIR__ . '/medical.routes.php';
        require __DIR__ . '/sports.routes.php';
        require __DIR__ . '/student_verification.routes.php';
        require __DIR__ . '/calendar.routes.php';
        require __DIR__ . '/tasks.routes.php';
        require __DIR__ . '/command_center.routes.php';
        require __DIR__ . '/daily_work.routes.php';
        require __DIR__ . '/short_url.routes.php';
        require __DIR__ . '/magic_login.routes.php';
        require __DIR__ . '/impersonation.routes.php';
        require __DIR__ . '/notice_board.routes.php';
        require __DIR__ . '/dashboard_header_ticker.routes.php';
        require __DIR__ . '/site_promotion.routes.php';
Route::get('teacher-evaluation-setting', [TeacherEvaluationController::class, 'teacherEvaluationSetting'])->name('teacher-evaluation-setting');
    ...
    Route::get('teacher-approved-evaluation-report', [TeacherEvaluationReportController::class, 'teacherApprovedEvaluationReport'])->name('teacher-approved-evaluation-report')->middleware('userRolePermission:teacher-approved-evaluation-report');
    Route::get('teacher-pending-evaluation-report', [TeacherEvaluationReportController::class, 'teacherPendingEvaluationReport'])->name('teacher-pending-evaluation-report')->middleware('userRolePermission:teacher-pending-evaluation-report');
    Route::get('teacher-wise-evaluation-report', [TeacherEvaluationReportController::class, 'teacherWiseEvaluationReport'])->name('teacher-wise-evaluation-report')->middleware('userRolePermission:teacher-wise-evaluation-report');

    // Teacher Evaluation Reports Search
    Route::get('teacher-approved-evaluation-report-search', [TeacherEvaluationReportController::class, 'teacherApprovedEvaluationReportSearch'])->name('teacher-approved-evaluation-report-search')->middleware('userRolePermission:teacher-approved-evaluation-report');
    Route::get('teacher-pending-evaluation-report-search', [TeacherEvaluationReportController::class, 'teacherPendingEvaluationReportSearch'])->name('teacher-pending-evaluation-report-search')->middleware('userRolePermission:teacher-pending-evaluation-report');
    Route::get('teacher-wise-evaluation-report-search', [TeacherEvaluationReportController::class, 'teacherWiseEvaluationReportSearch'])->name('teacher-wise-evaluation-report-search')->middleware('userRolePermission:teacher-wise-evaluation-report');

    // Teacher Evaluation Reports Save/Delete
    Route::get('teacher-evaluation-approve-submit/{id}', [TeacherEvaluationReportController::class, 'teacherEvaluationApproveSubmit'])->name('teacher-evaluation-approve-submit')->middleware('userRolePermission:teacher-pending-evaluation-report');
    Route::get('teacher-evaluation-approve-delete/{id}', [TeacherEvaluationReportController::class, 'teacherEvaluationApproveDelete'])->name('teacher-evaluation-approve-delete')->middleware('userRolePermission:teacher-pending-evaluation-report');

    Route::get('teacher-panel-evaluation-report', [TeacherEvaluationReportController::class, 'teacherPanelEvaluationReport'])->name('teacher-panel-evaluation-report')->middleware('userRolePermission:teacher-panel-evaluation-report');
    ...
    // Document Generator
    Route::get('document-generator', 'Admin\AdminSection\SmDocumentGeneratorController@index')
        ->name('document-generator')
        ->middleware('userRolePermission:document-generator');
    Route::get('document-generator/students/{class_id}/{section_id}', 'Admin\AdminSection\SmDocumentGeneratorController@getStudents')
        ->name('document-generator.students')
        ->middleware('userRolePermission:document-generator.students');
    Route::get('document-generator/student-details/{student}', 'Admin\AdminSection\SmDocumentGeneratorController@getStudentDetails')
        ->name('document-generator.student-details')
        ->middleware('userRolePermission:document-generator.student-details');
    Route::post('document-generator/print', 'Admin\AdminSection\SmDocumentGeneratorController@print')
        ->name('document-generator.print')
        ->middleware('userRolePermission:document-generator.print');
    Route::get('document-generator/requests', 'Admin\AdminSection\SmDocumentGeneratorController@requests')
        ->name('document-generator.requests')
        ->middleware('userRolePermission:document-generator.requests');
    Route::post('document-generator/requests/{documentRequest}/status', 'Admin\AdminSection\SmDocumentGeneratorController@updateStatus')
        ->name('document-generator.update-status')
        ->middleware('userRolePermission:document-generator.update-status');
    Route::get('document-generator/preview', 'Admin\AdminSection\SmDocumentGeneratorController@getDocumentPreview')
        ->name('document-generator.preview')
        ->middleware('userRolePermission:document-generator');
    Route::get('document-generator/template-fields/{template}', 'Admin\AdminSection\SmDocumentGeneratorController@getTemplateFields')
        ->name('document-generator.template-fields')
        ->middleware('userRolePermission:document-generator.template-fields');

    Route::get('document-generator/templates', 'Admin\AdminSection\SmDocumentTemplateController@index')
        ->name('document-generator.templates')
        ->middleware('userRolePermission:document-generator.templates');
    Route::get('document-generator/templates/create', 'Admin\AdminSection\SmDocumentTemplateController@create')
        ->name('document-generator.templates.create')
        ->middleware('userRolePermission:document-generator.templates.create');
    Route::post('document-generator/templates', 'Admin\AdminSection\SmDocumentTemplateController@store')
        ->name('document-generator.templates.store')
        ->middleware('userRolePermission:document-generator.templates.store');
    Route::get('document-generator/templates/{template}/edit', 'Admin\AdminSection\SmDocumentTemplateController@edit')
        ->name('document-generator.templates.edit')
        ->middleware('userRolePermission:document-generator.templates.edit');
    Route::post('document-generator/templates/preview-html', 'Admin\AdminSection\SmDocumentTemplateController@previewHtml')
        ->name('document-generator.templates.preview-html')
        ->middleware('userRolePermission:document-generator.templates.edit');
    Route::post('document-generator/templates/access', 'Admin\AdminSection\SmDocumentTemplateController@updateAccess')
        ->name('document-generator.templates.access')
        ->middleware('userRolePermission:document-generator.templates');
    Route::post('document-generator/templates/{template}', 'Admin\AdminSection\SmDocumentTemplateController@update')
        ->name('document-generator.templates.update')
        ->middleware('userRolePermission:document-generator.templates.update');
    Route::delete('document-generator/templates/{template}', 'Admin\AdminSection\SmDocumentTemplateController@destroy')
        ->name('document-generator.templates.delete')
        ->middleware('userRolePermission:document-generator.templates.delete');

    // ERP Template Designer
    Route::get('erp-templates', 'Admin\AdminSection\ErpTemplateController@index')
        ->name('erp-templates.index')
        ->middleware('userRolePermission:erp-templates.index');
    Route::get('erp-templates/create', 'Admin\AdminSection\ErpTemplateController@create')
        ->name('erp-templates.create')
        ->middleware('userRolePermission:erp-templates.create');
    Route::post('erp-templates', 'Admin\AdminSection\ErpTemplateController@store')
        ->name('erp-templates.store')
        ->middleware('userRolePermission:erp-templates.store');
    Route::get('erp-templates/{id}/edit', 'Admin\AdminSection\ErpTemplateController@edit')
        ->name('erp-templates.edit')
        ->middleware('userRolePermission:erp-templates.edit');
    Route::post('erp-templates/{id}', 'Admin\AdminSection\ErpTemplateController@update')
        ->name('erp-templates.update')
        ->middleware('userRolePermission:erp-templates.update');
    Route::post('erp-templates/{id}/delete', 'Admin\AdminSection\ErpTemplateController@destroy')
        ->name('erp-templates.delete')
        ->middleware('userRolePermission:erp-templates.delete');
    Route::delete('erp-templates/{id}', 'Admin\AdminSection\ErpTemplateController@destroy')
        ->name('erp-templates.delete.legacy')
        ->middleware('userRolePermission:erp-templates.delete');
    Route::post('erp-templates/{id}/duplicate', 'Admin\AdminSection\ErpTemplateController@duplicate')
        ->name('erp-templates.duplicate')
        ->middleware('userRolePermission:erp-templates.create');
    Route::get('erp-templates/{id}/design', 'Admin\AdminSection\ErpTemplateController@design')
        ->name('erp-templates.design')
        ->middleware('userRolePermission:erp-templates.design');
    Route::get('erp-templates/{id}/versions', 'Admin\AdminSection\ErpTemplateController@versions')
        ->name('erp-templates.versions')
        ->middleware('userRolePermission:erp-templates.design');
    Route::post('erp-templates/{id}/versions', 'Admin\AdminSection\ErpTemplateController@storeVersion')
        ->name('erp-templates.versions.store')
        ->middleware('userRolePermission:erp-templates.design');
    Route::post('erp-templates/{id}/rollback', 'Admin\AdminSection\ErpTemplateController@rollback')
        ->name('erp-templates.versions.rollback')
        ->middleware('userRolePermission:erp-templates.design');
    Route::get('erp-templates-api/variables', 'Admin\AdminSection\ErpTemplateController@variableRegistry')
        ->name('erp-templates.variables')
        ->middleware('userRolePermission:erp-templates.index');
    Route::get('erp-templates/{id}/render-contexts', 'Admin\AdminSection\ErpTemplateController@renderContexts')
        ->name('erp-templates.render.contexts')
        ->middleware('userRolePermission:erp-templates.render');
    Route::post('erp-templates/{id}/render', 'Admin\AdminSection\ErpTemplateController@renderDocument')
        ->name('erp-templates.render')
        ->middleware('userRolePermission:erp-templates.render');
    Route::post('erp-templates/{id}/render/bulk', 'Admin\AdminSection\ErpTemplateController@queueBulkRender')
        ->name('erp-templates.render.bulk')
        ->middleware('userRolePermission:erp-templates.render');
    Route::get('erp-templates/render-jobs/{jobId}', 'Admin\AdminSection\ErpTemplateController@renderJobStatus')
        ->name('erp-templates.render.job')
        ->middleware('userRolePermission:erp-templates.render');
    Route::get('erp-templates/render-jobs/{jobId}/download', 'Admin\AdminSection\ErpTemplateController@downloadRenderJob')
        ->name('erp-templates.render.download')
        ->middleware('userRolePermission:erp-templates.render');

    Route::get('erp-template-assets', 'Admin\AdminSection\ErpTemplateAssetController@index')
        ->name('erp-template-assets.index')
        ->middleware('userRolePermission:erp-template-assets.index');
    Route::post('erp-template-assets', 'Admin\AdminSection\ErpTemplateAssetController@store')
        ->name('erp-template-assets.store')
        ->middleware('userRolePermission:erp-template-assets.store');
    Route::post('erp-template-assets/{id}', 'Admin\AdminSection\ErpTemplateAssetController@update')
        ->name('erp-template-assets.update')
        ->middleware('userRolePermission:erp-template-assets.store');
    Route::post('erp-template-assets/{id}/transform', 'Admin\AdminSection\ErpTemplateAssetController@transform')
        ->name('erp-template-assets.transform')
        ->middleware('userRolePermission:erp-template-assets.store');
    Route::post('erp-template-assets/{id}/delete', 'Admin\AdminSection\ErpTemplateAssetController@destroy')
        ->name('erp-template-assets.delete')
        ->middleware('userRolePermission:erp-template-assets.delete');
    Route::delete('erp-template-assets/{id}', 'Admin\AdminSection\ErpTemplateAssetController@destroy')
        ->name('erp-template-assets.delete.legacy')
        ->middleware('userRolePermission:erp-template-assets.delete');

    Route::get('erp-template-variables', 'Admin\AdminSection\ErpTemplateVariableController@index')
        ->name('erp-template-variables.index')
        ->middleware('userRolePermission:erp-template-variables.index');
    Route::post('erp-template-variables', 'Admin\AdminSection\ErpTemplateVariableController@store')
        ->name('erp-template-variables.store')
        ->middleware('userRolePermission:erp-template-variables.index');
    Route::post('erp-template-variables/{id}', 'Admin\AdminSection\ErpTemplateVariableController@update')
        ->name('erp-template-variables.update')
        ->middleware('userRolePermission:erp-template-variables.index');
    Route::post('erp-template-variables/{id}/delete', 'Admin\AdminSection\ErpTemplateVariableController@destroy')
        ->name('erp-template-variables.delete')
        ->middleware('userRolePermission:erp-template-variables.index');
    Route::delete('erp-template-variables/{id}', 'Admin\AdminSection\ErpTemplateVariableController@destroy')
        ->name('erp-template-variables.delete.legacy')
        ->middleware('userRolePermission:erp-template-variables.index');
